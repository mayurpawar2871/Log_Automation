...
#95 percent working only 2 bugs.....unccessry printing filename path & "3" no counts also printing below 
...
fileinfo=glob.glob("/home/sim/Documents/SHM/Testing/Scan_report/sample_logs/*.txt")
...
sheet.write(2, 5,'HOW MANY PASSED')

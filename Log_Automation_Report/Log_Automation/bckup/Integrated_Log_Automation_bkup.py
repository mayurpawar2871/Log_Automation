...
pass_count=0
for i in range(sheet.nrows):     #new
    keyword_counter=sheet.cell_value(i, 4)    #new
    for filename, text in files.items():
        print("filename=",filename)
        #print("=" * 80)
    	#print(text)
    
    	count_times=text.count(keyword_counter)   #new  ,removed variable
    	sub_index = text.find(keyword_counter)     #new ,removed variable
